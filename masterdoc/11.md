...
6. After the import is successful, you can go to items view of the workspace and see the newly imported notebooks. Select **wwilakehouse lakehouse** to open it.

![opennotebook]()

7. Once the wwilakehouse lakehouse is opened, select Open notebook > Existing notebook from the top navigation menu.

![existing]()

8.From the list of existing notebooks, select the 01 - Create Delta Tables notebook and select **Open**.
9.In the open notebook in **Lakehouse explorer**, you will see the notebook is already linked to your opened lakehouse.

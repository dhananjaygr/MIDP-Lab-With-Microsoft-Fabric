...
1. On the left pane of the Databricks web session (tab), opened in Exercise 2, navigate to the top dropdown list where the **Data Science & Engineering** persona is selected. Select the **Machine Learning** persona.
...
2. Select the **Workspace** icon (first icon) in the left pane, and then select the **ML Solutions in OneBox** notebook. Once the notebook is open, click on > to expand notebooks **Table of content**.

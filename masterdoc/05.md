...
3. Scroll down notebook to review the **cmd 11** cell, and then review the output for **Exploratory Data Analysis**.
   ...
   ![cmd 11](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3103.png?raw=true)

4. Review the **cmd 29** cell.

By analyzing Customer Churn data, we create multiple Machine Learning models.

![Runs using a parallel coordinates](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3115.png?raw=true)
...
![Load Azure ML workspace](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3119.png?raw=true)
...
11. Review the **cmd 127** cell where model deployment is created.
    ...
    ![Model Deployement](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3136.png?raw=true)
...
12. Review the **cmd 133** cell to see sales forecast using store data after launching the campaigns.
    ...
    ![Store data after the campaigns ](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3138.png?raw=true)
...
![Select upload](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3208.png?raw=true)

4.	Select the **Local File** tile.

![Select upload](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image3209.png?raw=true)
...
![Upload report upload](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/imageFilePath.png?raw=true)
...
![Select Azure Databricks resource](https://github.com/SD-14/Ignite-Demo/blob/main/media/images/image2104.png?raw=true)

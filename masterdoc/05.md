...
7. In Synapse Studio, on the left, select the **Develop** hub icon (the third from the top).
...
8. In the **Develop** pane, expand **SQL scripts**.

9. Select the **1 Query Campaign And Twitter Data Using T-SQL Language** script.
...
10. In the **Connect to** dropdown list, ensure that **Built-in** is selected.
...
15. To create a view that queries the first 100 campaigns, select lines 35-44 in the script file.

16. Select **Run** to create a view of the Campaign file in the Serverless pool.
...
17. Select **Data** from the left pane.

18. Under **SQL Database**, expand **AnalyticsServerlesspool(SQL)**, expand the **Views** folder.

19. Expand **dbo.Vw_CampaignData** to open the **Columns** folder and review the columns.

...
3. To upload a Power BI Desktop file, on the **New** dropdown menu, select **Upload a file**.

> **Note:** Please make sure you are **logged into the VM** for the following steps.

![Select upload](https://github.com/CloudLabsAI-Azure/Ignite-lab/blob/main/media/image3208.png?raw=true)

4.	Select the **Local File** tile.

![Select upload](https://github.com/CloudLabsAI-Azure/Ignite-lab/blob/main/media/image3209.png?raw=true)
...
![Raw Twitter data](https://github.com/CloudLabsAI-Azure/Ignite-lab/blob/main/media/image3406.png?raw=true)
...
![Filtered Twitter data](https://github.com/CloudLabsAI-Azure/Ignite-lab/blob/main/media/image3407.png?raw=true)
...
![Curated Twitter data](https://github.com/CloudLabsAI-Azure/Ignite-lab/blob/main/media/image3408.png?raw=true)
...
![Aggregations Are A Great User Experience Enhancement](https://github.com/CloudLabsAI-Azure/Ignite-lab/blob/main/media/image3410.png?raw=true)
...
![Z-Order Optimization](https://github.com/CloudLabsAI-Azure/Ignite-lab/blob/main/media/image3411.png?raw=true)
...
![Caching](https://github.com/CloudLabsAI-Azure/Ignite-lab/blob/main/media/image3412.png?raw=true)
...
![Time Travel](https://github.com/CloudLabsAI-Azure/Ignite-lab/blob/main/media/image3413.png?raw=true)
